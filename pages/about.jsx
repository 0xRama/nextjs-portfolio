    ...
    <div className={style.about}>
      ...
      <div className={style.left}>
        ...
        >
          ...
          <span>* Self Taught Developer and InfoSec Student</span>
          <span>* with 2 years experience and maintaining</span>
          <span>* responsive websites.</span>
          <span>* Proficient in HTML, CSS, JavaScript and React</span>
          <span>* and CTF Player </span>
            ...
            <div className={style.right_interest}>
              ...
              <div className={style.skill}>
                ...
                <AnimatePresence>
                  {showReact && (
                    ...
                    >
                      <p>
                        <BsMarkdownFill /> html-css-js.md
                      </p>
                      <p>
                        <BsMarkdownFill /> react.md
                      </p>
                      <p>
              ...
              <div className={style.skill}>
                ...
                >
                  ...
                  <span> Other Programming Languages</span>
                </div>
                <AnimatePresence>
                  {showNext && (
                    <motion.div
                ...
                <AnimatePresence>
                  {showLibrary && (
                    ...
                    >
                      ...
                      <p>
                        <BsMarkdownFill /> Adobe XD.md
                      </p>
                      <p>
                        <BsMarkdownFill /> Adobe Illustrator.md
                      </p>
                    </motion.div>
                  )}
                </AnimatePresence>
                ...
                <AnimatePresence>
                  {showFree && (
                    ...
                    >
                      ...
                      <p>
                        <BsMarkdownFill /> Listen Audio Books.md
                      </p>
                      <p>
                        <BsMarkdownFill /> Music.md
                      </p>
                    </motion.div>
                  )}
                </AnimatePresence>
